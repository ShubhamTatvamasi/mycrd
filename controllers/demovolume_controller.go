...
import (
	...
	demov1 "github.com/ShubhamTatvamasi/mycrd/api/v1"
...
//+kubebuilder:rbac:groups=demo.shubhamtatvamasi.com,resources=demovolumes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=demo.shubhamtatvamasi.com,resources=demovolumes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=demo.shubhamtatvamasi.com,resources=demovolumes/finalizers,verbs=update
	...
	pvc = &v1.PersistentVolumeClaim{
		...
		Spec: v1.PersistentVolumeClaimSpec{
			...
			Resources: v1.ResourceRequirements{
				Requests: v1.ResourceList{"storage": storageReq},
			},
		},
	}
